                ...
                <div className="offer_main_intro-wrapper">
                  <div className="offer_main_intro">
                    ...
                    <div className="offer_main_intro_detail">
                      ...
                      <div className="with-more-hidden">
                  ...
                  <div className="offer_main_mini-reviews">
                    <div className="offer_main_mini-reviews-left">
                      ...
                      <div className="offer_main_mini-reviews-sub">
                        <div className="mini-reviews-star-rating"></div>
                        <p>후기 112개</p>
                      </div>
                    </div>
                    <div className="offer_main_mini-reviews-right">
                      <div className="mini-reviews-star"></div>
                      <p>이**</p>
                  ...
                  <div className="offer_main_require">
                    ...
                    <div>
                      ...
                      ▶ 투어 종료시간(예상) : 약 오후 1시반
                      <br />
                      ▶ 투어 최소 인원 : 2명 (1인 미만 예약 시 일주일전 안내
                      드린 후 투어가 취소될 수 있습니다.)
                      <br />
                      ▶ 투어 진행 최소 나이 : 만 15세부터
                      <br />
                      ▶ 수신기를 사용하기 때문에 개인 이어폰(3.5mm 스테레오잭)
                      을 반드시 준비해주시기 바랍니다. 에어팟, 블루투스이어폰
                      사용하지 못 합니다.
                      <br />
                      ▶ 택시비 각 1인 6유로
                      <br />▶ 사그라다 파밀리아 성당에 입장하시는 경우
                      복장제한이 있습니다. 민소매, 짧은 반바지, 모자 착용하신
                      경우 입장 제한 됩니다. 하여 되도록이면 성당에 입장하시는
                      분들은 복장에 신경써주시길 부탁드립니다.
                      <br />
                      <br />
                      <br />
                      <br />
                      ...
                      <br />
                      - 예약 확정과 동시에 티켓을 사전 예매하므로, 예약 확정
                      이후 투어 취소 시 구엘공원 입장권 금액을 뺀 금액만
                      환불됩니다.
                      <br />
                      - 현지 사정에 따라 티켓 마감, 전산 오류 등의 이유로
                      구엘공원 입장이 불가할 수도 있습니다.
                      <br />
                      ...
                      구매하시기 바랍니다.
                      <br />
                      그러나 점심 식사 후 입장하실 거라면 15:30 티켓을
                      구매하시는 것을 추천드립니다.
                      <br />
                      ...
                      ☞ 소수투어 최대 7인!
                      <br />
                      오랜 경험을 통해 느낀 것이 있습니다. 바로 고객과의
                      유대감이 얼마나 중요한가 입니다.
                      <br />
                      5시간이라는 시간은 많은 것을 설명하기엔 정말 짧은
                      시간입니다.
                      <br />
                      이 시간동안 유대감을 쌓는것도 어려운이죠 하지만
                      소수인원으로 진행하며 이 부분을 개선했습니다
                      <br />
                      ...
                      ☞ 인생샷? 걱정마~
                      <br />
                      무심한듯 찍지만 오해하지 마세요~ 워낙 많이 찍어줘서
                      그래요~ 키가 커지고 싶다고요? 날씬해 보이고 싶다고요?
                      포샵이 필요 없도록 찍어드릴게요~
                      <br />
                      <br />
                      ☞ 검증 된 가이드
                  ...
                  <div className="offer_main_guide">
                    ...
                    <div className="offer_main_guide_content">
                      <div className="guide_content-detail">
                        12살 어린시절 너무나(?) 활발하고 튼튼했던 나에게
                        느닷없이 찾아와 꿈을 안겨주었던 운동
                        <br />
                        그것은 바로 배구
                        <br />
                        ...
                        <br />
                        <br />
                        첫번째 꿈을 접어지며 [세상에서 가장 쉬운건 공부] 라는
                        되도 않는 말이 왜 있는것인지 알게 되었다.
                        <br />
                        그래서 평소 재밋어 하던 일본어를 공부를 하여, 관광과에
                        가게 된다.
                        <br />
                        '세상은 중간이 제일 좋은거다' 라며 덜하지도 더하지도
                        않게 나는 평범한 회사원이 되었다.
                        <br />
                        <br />
                        회사 생활 어느덧 4년차..
                        ...
                        <br />
                        <br />
                        유럽에 관심 없었던 나에게 Camino de Santiago
                        성지순례길을 다녀온 내 친구는
                        <br />
                        스페인을 가보라며 추천하였고 그동안에 회사생활에
                        지쳐있던 난 정말 아무 생각없이 비행기 표를 사고 첫
                        유럽여행을 떠났다.
                        <br />
                        <br />
                        ...
                        그치만 나에게 스페인의 바르셀로나는
                        <br />
                        나 1명이 행복하면 7명이 같이 행복할것이라는 '교훈'을
                        얻게 해주었고,
                        <br />
                        잊지못할 '인연'을 만들어주고,
                        <br />
                  ...
                  <div className="offer_main_refund">
                    ...
                    <div className="offer_main_refund_content">
                      <div className="refund_content-detail">
                        ...
                        이루어진 후 투어 개시일 이전에 여행계약을 임의로
                        해제하는 경우, 해제 통보 시점에 관한 다음 각 호의 기준에
                        따라 여행요금이 환불됩니다.
                        <br />
                        해제 통보 시점은 환불요청서가 마이리얼트립 플랫폼에
                        접수된 시간 또는 마이리얼트립 플랫폼 내 ‘메시지’ 기능을
                        통하여 환불요청 내용이 기록된 시간을 기준으로 합니다.
                        <br />
                        [국외여행의 경우]
                        <br />
                        - 여행시작 30일전 (~30) 까지 통보시: 여행 요금 전액 환불
                        <br />
                        - 여행시작 20일 전까지 (29~20) 통보시: 여행요금에서
                        가이드 요금의 10%와 마이리얼트립 수수료 공제 후 환불
                        <br />
                        ...
                        공제 후 환불
                        <br />
                        - 여행 시작 시간으로부터 24시간 이내 통보 시:
                        여행요금에서 가이드 요금의 30%와 마이리얼트립 수수료
                        공제 후 환불
                        <br />
                        다만, 위의 규정에도 불구하고 다음의 경우에는 예외로
                        합니다.
                        <br />
                        1) 여행자가 여행요금을 결제(지급)한 때로부터 24시간
                        이내에 여행계약을 철회(취소)하는 경우와 여행자가 투어
                        예약 후 가이드가 확정되기 전에 취소하는 경우는
                        여행요금을 전액 환불합니다. 단, 여행자가 여행요금을
                        결제하였다고 하더라도 해당 시점으로부터 24시간 이내
                        여행이 시작될 경우 (Instant Booking 예약에 해당하는
                        경우)는 전액 환불 대상에서 제외합니다.
                        <br />
                        2) 상품의 특성에 따라 현지 예약금으로 지불되어야 하는
                        금액이 있는 경우 해당 예약금의 환불에 대하여는 각 상품의
                        상세설명보기에서 별도로 고지한 취소환불 약관을
                        적용합니다.
                        <br />
                        <br />
                        ...
                        <br />
                        - 여행시작 20일 전까지 (29~20) 통보시: 여행요금에서
                        가이드 요금의 10%와 마이리얼트립 수수료를 가이드가 부담.
                        <br />
                        - 여행시작 6일 전까지 (19~6) 통보시: 여행요금에서 가이드
                        ...
                        <br />
                        - 여행 개시일로부터 여행 시작 시간 기준 24시간 이전 통보
                        시: 여행요금에서 가이드 요금의 20%와 마이리얼트립
                        수수료를 가이드가 부담.
                        <br />
                        - 여행 시작 시간으로부터 24시간 이내 통보 시:
                        여행요금에서 가이드 요금의 30%와 마이리얼트립 수수료를
                        가이드가 부담.
                        <br />
                        다만, 위의 규정에도 불구하고 다음의 경우에는 예외로
                        합니다.
                    ...
                    <div className="offer_main_reviews_list">
                      ...
                      <div className="reviews_list_reply">
                        ...
                        <p className="reveiws_list_reply-message">
                          안녕하세요 바르셀로나 Lucia 가이드 입니다 :)
                          정성스러운 후기 감사합니다. 저와 함께 투어를 잘
                          즐겨주셨다니 뿌듯하고 가이드로서 이런 말을 들으면 힘도
                          나도 더욱 열심히 해야겠다고 생각합니다 항상 건강하시고
                          늘 행복하시길 바라겠습니다~ 고맙습니다 :)
                        </p>
                      </div>
                    </div>
                    <hr />
