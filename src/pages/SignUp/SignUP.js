...
signup=()=>{
  fetch('http://10.58.7.201:8005/account/signup',{
    method:'POST',
    headers:{
  ...
  render() {
    ...
    const signupList = (pwLong&&pwShort&&pwCheck===true)
    &&(this.state.password===this.state.repassword)
    &&(this.state.agreeA&&this.state.agreeB === true);
      ...
      <div className="signUp">
        <div className="signUpWrap">
          ...
          <div className="personal">
                ...
                signupList
                ?
                <button className="signUpSubmit" onClick={this.signup}>회원가입</button>
